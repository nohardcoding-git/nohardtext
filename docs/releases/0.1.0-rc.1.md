# NoHardText 0.1.0-rc.1 Release Notes

## Summary

NoHardText `0.1.0-rc.1` is the first release candidate for the NoHardText CLI and core detection packages.
...
- Decide whether to publish `0.1.0-rc.1` or create another RC.
